...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(460.63, -995.93, 30.69), width = 2, length = 2, cameraLocation = vector4(460.63, -993.93, 30.69, 12.7)}, --vector3(454.43, -988.85, 30.69), width = 2, length = 2, cameraLocation = vector4(454.42, -990.52, 30.69, 358.48)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(298.67, -598.35, 43.28), width = 2, length = 2, cameraLocation = vector4(298.67, -598.35, 43.28, 61.34)}, -- Right double door in Hospital Map that is on QBCore GitHub
